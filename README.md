...
Este repositório reúne os conteúdos do Projeto Conta Bancária desenvolvidos durante o Bootcamp Java Full Stack da Generation Brasil (https://github.com/daniellecaricati/conta\_bancaria.git).
...
1\. Clone o repositório \[Projeto Conta Bancaria](https://github.com/daniellecaricati/conta\_bancaria.git) dentro da pasta do \*Workspace\* do Eclipse/STS



```bash

git clone https://github.com/daniellecaricati/conta\_bancaria.git
...
Desenvolvido por \[\*\*Danielle Caricati\*\*](https://github.com/daniellecaricati/conta\_bancaria.git)
